...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative dark:bg-gray-900 dark:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1 animate-fade-up">
            <span className="tag mb-4 animate-fade-in dark:bg-gray-800 dark:text-white">Frontend Developer</span>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in dark:text-white" style={{ animationDelay: '0.1s' }}>
              Kushal <span className="text-blue-600 dark:text-blue-400">Khanal</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 animate-fade-in dark:text-gray-300" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="space-y-4 mb-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:khanalkushal22@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">
          ...
          <div className="order-1 md:order-2 flex justify-center md:justify-end animate-scale-in">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 animate-pulse" style={{ animationDuration: '5s' }}></div>
              ...
              <div className="absolute inset-4 rounded-full bg-gradient-to-br from-blue-500/10 to-purple-500/10 dark:from-blue-400/10 dark:to-purple-400/10 flex items-center justify-center">
                <span className="text-7xl font-bold text-primary/40 dark:text-blue-500/40">K</span>
              </div>
            </div>
          </div>
        </div>
