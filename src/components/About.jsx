      ...
      <div className="">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass-card p-6 text-center transform transition-all duration-300 hover:scale-105 animate-fade-up dark:bg-gray-800/30 dark:border-gray-700" style={{ animationDelay: '0.3s' }}>
              ...
              <h3 className="text-lg font-semibold mb-2 dark:text-white">Modern Frontend</h3>
              <p className="text-gray-600 dark:text-gray-300">Building responsive, accessible web applications with modern technologies</p>
            </div>
            
            <div className="glass-card p-6 text-center transform transition-all duration-300 hover:scale-105 animate-fade-up dark:bg-gray-800/30 dark:border-gray-700" style={{ animationDelay: '0.4s' }}>
              ...
              <h3 className="text-lg font-semibold mb-2 dark:text-white">Fast Learner</h3>
              <p className="text-gray-600 dark:text-gray-300">Quickly adapting to new technologies and development methods</p>
            </div>
            
            <div className="glass-card p-6 text-center transform transition-all duration-300 hover:scale-105 animate-fade-up dark:bg-gray-800/30 dark:border-gray-700" style={{ animationDelay: '0.5s' }}>
              ...
              <h3 className="text-lg font-semibold mb-2 dark:text-white">Problem Solver</h3>
              <p className="text-gray-600 dark:text-gray-300">Attentive to detail with strong analytical and problem-solving abilities</p>
            </div>
          </div>
        </div>
      </div>
