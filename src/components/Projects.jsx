...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      link: "https://main--aayush-ecommercee.netlify.app/",
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 dark:text-white">
      <div className="max-w-[1200px] mx-auto px-5">
        <h2 className="section-title text-center text-3xl font-bold mb-4 animate-fade-up dark:text-white">Projects</h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto animate-fade-up dark:text-gray-300" style={{ animationDelay: '0.1s' }}>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.slice(0, 3).map((tech) => (
                    <span key={tech} className="px-2 py-1 text-xs rounded-full bg-secondary text-secondary-foreground dark:bg-blue-900 dark:text-blue-100">
                      {tech}
                    </span>
                  ))}
