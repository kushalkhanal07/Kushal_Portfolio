...
const Experience = () => {
  return (
    <section
      id="experience"
      className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 dark:text-white"
    >
      <div className="">
        <h2 className="section-title text-center text-3xl font-bold mb-12 animate-fade-up dark:text-white">
          Experience
        </h2>
                ...
                <div className="ml-6">
                  <div className="glass-card p-6 dark:bg-gray-800/30 dark:border-gray-700">
                    ...
                    <p className="text-gray-700 dark:text-gray-200">
                      Currently a freelancer, learning and working on various
                      web projects. Building and refining skills while
                ...
                <div className="ml-6">
                  <div className="glass-card p-6 dark:bg-gray-800/30 dark:border-gray-700">
                    ...
                    <p className="text-gray-700 dark:text-gray-200 text-justify">
                      Completed 3-month internship at Hyperlab. Gained valuable
                      industry experience and practical skills in web
                      development. Currently working as full time frontend web devloper and also working on backend development.
                    </p>
                      ...
                      <ul className="space-y-1 text-gray-700 dark:text-gray-200">
                        <li className="flex items-start">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="mr-2 text-green-500 dark:text-green-400 mt-1"
                          >
                        ...
                        <li className="flex items-start">
                          ...
                          <span>
                            Participated in team projects and development cycles
                          </span>
                        </li>
                        <li className="flex items-start">
                          <svg
                          ...
                          <span>
                            Learned modern development workflows and best
                            practices
                          </span>
                        </li>
                      </ul>
